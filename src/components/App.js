...
function App() {
  ...
  return (
    <div className="App">
      ...
      <MainContent addVote={addVote} subtractVote={subtractVote} 
      toggleComments={toggleComments} 
      handleCommentToggle={handleCommentToggle} 
      title={videoObj.title} createdAt={videoObj.createdAt} views={videoObj.views} 
      upvotes={videoObj.upvotes} downvotes={videoObj.downvotes}/>
